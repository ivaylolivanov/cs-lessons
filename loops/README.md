...
Foreach е цикъл, който е опростена разновидност на for цикъла. Спестява обхождането по индекс и условие за край. При стойностни типове данни създава копие на елемента за всяка итерация.

``` c#
    int[] myArray = {1, 5, 2, 3, 7, 9};
