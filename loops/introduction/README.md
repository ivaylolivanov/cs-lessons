...
Foreach е цикъл, който е опростена разновидност на for цикъла. Спестява обхождането по индекс и условие за край. Създава копие ако елементите не са от референтен тип данни.
