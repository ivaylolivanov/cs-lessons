...
<ul>
    <li>int</li>
        Съхранява цели числа.
    <li>double</li>
        Съхранява реални числа (числа с плаваща запетая) с точност от 15-17 символа след запетаята.
    <li>float</li>
        Съхранява реални числа (числа с плаваща запетая) с точност от 6-9 символа след запетаята.
    <li>char</li>
        Съхранява 1 символ. Заграждаме стойността с апострофи.
    <li>string</li>
        Низ от символи. Заграждаме стойността с кавички.
    <li>bool</li>
        Съхранява 1 от 2 възможни стойности - `false` и `true`.
</ul>
